...
import { findCourseRating } from "./helpers";
...
export default function Courses() {
  useInjectReducer({ key: "coursesPage", reducer });
  ...
  React.useEffect(() => {
    dispatch(operations.fetchCourses(coursePageType));
  }, []);
      ...
      <React.Fragment key={course.id}>
        <Col xs="12" md="6" lg="4">
          <CourseCard
            ...
            courseRating={findCourseRating(course.reviewedUsers)}
            onClick={onClick}
            onDelete={onDelete}
            onEdit={onEdit}
    ...
    <div className="webinars mx-3 mx-md-4 ml-lg-7">
      ...
      <Row className="mt-3">
        <div className="align-items-right ml-auto mr-3 mr-md-5">
          <Select text={coursePageType} options={dropdownOptions(dispatch)} />
