...
export const fetchPastCourses = (coursePageType, userId) => {
  return async (dispatch) => {
    try {
      const { data } = await getMyPastCourses(
        moment().format("MM/DD/YYYY"),
        userId
      );
      dispatch(setCourses(data));
